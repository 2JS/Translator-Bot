...
from discord import ApplicationContext, Embed, InteractionContextType
...
class StatsCommand(Cog):
  ...
  async def stats(self, ctx: ApplicationContext):
    ...
    # Footer :
    embed.set_footer(
      icon_url="https://cdn.discordapp.com/avatars/341257685901246466/ee4062cd8d5888421a51c2fc9875b9df.png?size=4096",
      text="unbonwhisky",
    )
    # Author :
    ...
    embed.add_field(name="Actual Server Shard :", value=ctx.guild.shard_id, inline=True)
    embed.add_field(
      name="Uptime :",
